...
- [ ] Full **8K MDA/CGA character-generator ROM** (BIOS `CRT_CHAR_GEN`) — after Bushido CGA path stays green
- [ ] MDA B000 live display in tdxview (Py86 default DIP 0x3D); CGA 3D9 palette (Py86 Gate 7)
- [ ] XT Xebec HDC
