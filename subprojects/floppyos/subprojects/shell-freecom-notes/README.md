...
**Priority:** P2  
**Role for FloppyOS:** Prefer over archived 4DOS-src (license-restricted). GPL gate before any code reuse in MIT core.

## Upstream

| Field | Value |
|-------|--------|
| Preferred URL | https://github.com/FDOS/freecom |
| Known good version | active FreeDOS shell |
