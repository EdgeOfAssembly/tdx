...
**Priority:** P0  
**Role for FloppyOS:** Standalone XMS when not using JemmEx. HimemX2 for low EMB cases.

## Upstream

| Field | Value |
|-------|--------|
| Preferred URL | https://github.com/Baron-von-Riedesel/HimemX |
| Known good version | v3.40 |
| License (upstream) | FD Himem GPL/Artistic; HimemX changes PD |
