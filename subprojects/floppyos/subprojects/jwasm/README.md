...
**Priority:** P0  
**Role for FloppyOS:** Required to rebuild HimemX, Jemm, HX, DOS-debug, ctmouse.

## Upstream

| Field | Value |
|-------|--------|
| Preferred URL | https://github.com/Baron-von-Riedesel/JWasm |
| Known good version | v2.20 stable / v2.21pre1 |
| License (upstream) | Open Watcom Public License (historical) |
